...
class V1FleetWorkersGet200Response(BaseModel):
    """
    V1FleetWorkersGet200Response
    """ # noqa: E501
    workers: List[V1FleetWorkersGet200ResponseWorkersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workers": [V1FleetWorkersGet200ResponseWorkersInner.from_dict(_item) for _item in obj["workers"]] if obj.get("workers") is not None else None
        })
        return _obj
