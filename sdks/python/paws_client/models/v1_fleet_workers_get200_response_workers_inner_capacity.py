...
class V1FleetWorkersGet200ResponseWorkersInnerCapacity(BaseModel):
    """
    V1FleetWorkersGet200ResponseWorkersInnerCapacity
    """ # noqa: E501
    max_concurrent: Annotated[int, Field(strict=True, ge=0)] = Field(alias="maxConcurrent")
    ...
    __properties: ClassVar[List[str]] = ["maxConcurrent", "running", "queued", "available"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maxConcurrent": obj.get("maxConcurrent"),
