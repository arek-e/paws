...
json = "{}"
# create an instance of V1DaemonsRoleDelete200Response from a JSON string
v1_daemons_role_delete200_response_instance = V1DaemonsRoleDelete200Response.from_json(json)
# print the JSON string representation of the object
print(V1DaemonsRoleDelete200Response.to_json())

# convert the object into a dict
v1_daemons_role_delete200_response_dict = v1_daemons_role_delete200_response_instance.to_dict()
